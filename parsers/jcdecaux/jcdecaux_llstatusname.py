...
def get(bsr_df, output='file', save_dir='', timeout_sec=20, apikey='', save_raw=False, save_raw_dir=''):
    ...
    for stn in json_data:
        clean_stations_list.append([stn['number'], stn['position']['lat'], stn['position']['lng'], stn['available_bikes'], stn['available_bike_stands'], stn['name']])
